...
const BorrowingConfirmationLayout = ({ books }: { books: BookInterface[] | null }) => {
  return (
    <div className="col-span-12 md:col-span-5 min-h-96 p-4 flex flex-col gap-y-5 bg-white rounded-md">
