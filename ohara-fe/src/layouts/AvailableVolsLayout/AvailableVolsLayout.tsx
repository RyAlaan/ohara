      ...
      <div className="w-full max-w-full overflow-auto sidebar-thin *:w-full *:px-1.5 *:md:px-4 *:py-2 *:flex *:flex-row *:items-start *:border-b *:border-dashed *:gap-x-4 *:justify-between">
        ...
        {books &&
          books.slice(0, 8).map((book: BookInterface) => (
            ...
            >
              <div className="h-full min-w-28 text-sm align-left">
                <p>#{book.id}</p>
              </div>
              <div className="h-full min-w-60 text-sm flex flex-row items-center gap-x-2">
                <img
                  src={book.cover}
                  alt=""
              ...
              <div className="h-full min-w-24 text-sm text-center font-semibold">
                <div
                  className={clsx(
              ...
              <div className="h-full min-w-14 flex flex-row justify-center items-end gap-x-1 *:cursor-pointer">
                <Link
                  to={`/books/${book.id}`}
